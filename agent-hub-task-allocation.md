...
| 状态 | 任务 |
|---|---|
| completed | `HUB-000`、`HUB-010` |
| ready now | `HUB-020`、`HUB-030`、`HUB-100`、`HUB-120` |
| blocked by HUB-100 | `HUB-110`、`HUB-130` |
| later | `HUB-200` 及后续任务 |

协议冻结点为 `contracts-frozen-v1`。下一波四个任务使用 `development-tasks/next-wave/` 中的独立简报和 worktree；`main` 只用于已审查任务的最终集成。
