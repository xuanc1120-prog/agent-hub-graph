...
阶段门：HUB-010 经 Codex 审查并提交 `contracts-frozen-v1` tag 后，才能进入阶段 1。
...
| HUB-120 | H | Claude Code | Codex | RuleBasedPlanner、PlannerContextBundle、AgentRouter、Workflow lineage 和 Planner fallback | HUB-010 |
